...
public class AGEMultiMachines {
    ...
    public static final MultiblockMachineDefinition KINETIC_CONCRETE_PLANT = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("FF FF", "FXXXF", "XXXXX", "XXKXX", "XXXXX", " XXX ")
                    .aisle("F   F", "XXXXX", "X###X", "X#G#X", "X###X", "XXXXX")
                    .aisle("     ", "XXXXX", "X#G#X", "KPPPK", "X#G#X", "XXXXX")
                    .aisle("F   F", "XXXXX", "X###X", "X#G#X", "X###X", "XXXXX")
    ...
    public static final MultiblockMachineDefinition CONCRETE_PLANT = REGISTRATE
            ...
            .pattern(definition -> FactoryBlockPattern.start()
                    .aisle("FF FF", "FXXXF", "XXXXX", "XXXXX", "XXXXX", " XXX ")
                    .aisle("F   F", "XXXXX", "X###X", "X#G#X", "X###X", "XXXXX")
                    .aisle("     ", "XXXXX", "X#G#X", "PPPPX", "X#G#X", "XXXXX")
                    .aisle("F   F", "XXXXX", "X###X", "X#G#X", "X###X", "XXXXX")
                    .aisle("FF FF", "FXXXF", "XXXXX", "XX@XX", "XXXXX", " XXX ")
                    .where("@", controller(blocks(definition.get())))
